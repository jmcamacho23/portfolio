...
async def test_calcareers_jobs_scraper_paging():
    ...
    async with async_playwright() as p:
        ...
        await ccpage.set_extra_http_headers(vars.CHROME_USER_AGENT)

        print(f'Going to CalCareers now...')
        await ccpage.goto(vars.CCSEARCHPAGEURL, wait_until="networkidle")
        try:
    ...
    print(f'CalCareers jobs list ({len(calcareers_job_tiles)}) (paging): ')
